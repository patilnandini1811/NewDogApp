...
export default function AllProfile(props) {
  ...
  // const [ isChecked, setIsChecked ] = useState(selectedDog.isPresent || false);
   // set initial value to the dog's existing isPresent value or false
   const [ isChecked, setIsChecked ] = useState(selectedDog.isPresent);
  ...
  const handleDogPresentStatusChange = (id, isPresent) => {
    ...
    // props.setDogData(updatedDogData);//new added
  };
